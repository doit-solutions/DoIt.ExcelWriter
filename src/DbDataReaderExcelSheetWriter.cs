        ...
        (
            Enumerable
                ...
                .Select(async idx => reader.GetFieldType(idx) switch
                {
                    ...
                    var type when type == typeof(ushort) => (object?)(await reader.IsDBNullAsync(idx, cancellationToken) ? null : await reader.GetFieldValueAsync<ushort>(idx, cancellationToken)),
                    ...
                    var type when type == typeof(uint) => (object?)(await reader.IsDBNullAsync(idx, cancellationToken) ? null : await reader.GetFieldValueAsync<uint>(idx, cancellationToken)),
                    ...
                    var type when type == typeof(ulong) => (object?)(await reader.IsDBNullAsync(idx, cancellationToken) ? null : await reader.GetFieldValueAsync<ulong>(idx, cancellationToken)),
